...
const testtimonialdata = [
  ...
  },
  {
    ...
    name: "Manuel Curfe ",
    picture: Manuel,
    postition: "Lead Dev @WaysToMakeMoney (W2MM)",
    description:
      "I absolutely loved the way Tamal worked with the Frontend design of the web site and fixed all the responsiveness, i would highly recommend him for such roles.",
  },
  {
    id: 3,
    name: "Donald Baker",
...
export default testtimonialdata;
